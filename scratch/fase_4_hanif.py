...
if 'mitra' in transformed_dfs:
    ...
    display(transformed_dfs['mitra'][['nama_mitra', 'nama_instansi', 'kode_mitra', 'is_leapverse', 'status_kemitraan']].head(5))
